...
export function Footer() {
  ...
  return <footer className="site-footer"><div className="footer-columns">
    ...
    <div><h3>{t("nav.legal")}</h3><Link href="/legal/privacy">Confidentialité et données</Link><Link href="/legal/data-rights">Exercer mes droits</Link><Link href="/legal/complaints">Réclamations</Link><Link href="/legal/terms">Conditions d’utilisation</Link><Link href="/legal/notices">Mentions légales</Link><Link href="/legal/cookies">{t("footer.cookies")}</Link></div>
